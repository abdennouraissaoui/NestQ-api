...
const questionList = [
        ...
        "answer":
            <div>
                <p style={paragraphStyle}>
                    When you put money in a savings account, you are guaranteed to earn whatever interest rate the bank offers. That is, if the bank offers 1.5% per year, then that’s exactly what you’ll get. You can find out which banks offer the best rates <a href="https://www.highinterestsavings.ca/chart/"> here</a> if you’re in Canada or  <a href="https://www.bankrate.com/banking/savings/rates/"> here </a>  if you’re in the United States.
                </p>
            </div>
    },
    {
    ...
    },
    {
        ...
        "answer": <div>
            <p>
                There’s a very famous saying in finance: high risk = high reward. That is, the more risk you take, the more return you expect to earn. This is intuitive – It would be silly to invest in something risky and not expect a high return in exchange!
            </p>
    ...
    },
    {
        ...
        "answer": <div>
            <p>
                ...
                Suppose you believe the U.S economy will continue to be strong. You know that some stocks will perform poorly but the majority will do well. Since you’re not exactly sure which stocks to buy, you decided to buy them all! Well, that’s not practical at all – it’ll take you forever to buy every single one and the fees for this approach are ridiculously high.
    ...
    },
    {
        ...
        "description": "Inspired by Ray Dalio's approach",
        "answer": <div>
            <p>
                ...
                The above criteria leaves me with 9 ETFs (bets). Since they’re all uncorrelated and made great returns in the past, what’s the likelihood that they will all fail? 
                Unless something terrible happens – perish the thought – I think that’s next to 0. Perhaps one, two or three bets will fail but I am confident that the rest will do great!
            </p>
        </div>
    },
    {
    ...
    },
    {
        ...
        "answer": <div>
            <p>
                Allocation type refers to what percentage each ETF should represent on your portfolio. You can enter the percentages (weights) manually or let one of the optimization techniques available do that for you you.
            </p>
        </div>
    },
    {
        ...
        "answer": <div>
            <p>
                Below I explain what each optimizer does, you can choose the one that fits your needs:
            </p>
            <ul>
                <li>
                    Maximum Sharpe Ratio: Maximize the return per unit of risk (Ratio of return to risk)
                </li>
                <li>
                    Efficient Return: Achieve a certain level of return with the lowest amount of risk possible
                </li>
                <li>
                    Efficient Volatility: Achieve the highest level of return possible for a given amount of risk
                </li>
                <li>
                    Minimum Volatility: Achieve the highest level of return possible for the least amount of risk possible
                </li>
                <li>
                    Hierarchical Risk Parity: Another method for building a portfolio with the least amount of risk. This method is shown to be more robust in out-of-sample than Minimum Volatility
                </li>
            </ul>
    ...
    },
    {
        ...
        "answer": <div>
            <p>
                An L2-Regularizer prevents the optimizer, if possible, from concentrating the allocation to few ETFs and neglect the others. I suggest activating this feature for a more robust and diversified portfolio.
            </p>
        </div>
    },
    {
        "question": "Portfolio Form: What is Optimization Period?",
        "description": "The period for which you want the optimizer to base its allocation decision",
        "answer": <div>
            <p>
                ...
                Here’s what you can do about this: optimize a portfolio for a period of your choice, then test it in a different period. For example, optimize your portfolio for period A, say 2006 to 2015, and analyze in period B, say 2016 to 2020 and assess whether it achieves its objective. If it does, there’s a higher probability that this objective will be achieved again if you start investing today. But once again, no guarantee!
    ...
    },
    {
        ...
        "answer": <div>
            ...
            <ul>
                <li>
                    Market Risk: if all stocks, on average, move up by 1%, by which multiple of 1% does my portfolio move? For example, if the multiple is 2, it means when stocks go up by 1% your portfolio on average moved up by 2%
                </li>
                <li>
                    Size Risk: like the above, except instead of considering all stocks, we only consider small stocks (low market capitalization). Smaller stocks are riskier and thus are expected to deliver higher returns
                </li>
                <li>
                    Value Risk: Also like the above, except we only consider
                </li>
                <li>
                    Alpha: How much additional return you make per month without taking any of the risks listed above => the higher the better
                </li>
                <li>
                    R-Square: How much of the variation in the returns of my portfolios is due to the risks above
                </li>
    ...
    },
    {
        ...
        "answer": <div>
            <p>
                The historical return on an investment per year. For reference, I believe the average savings account returns approximately 1.5% per year
            </p>
        </div>
    },
    {
        ...
        "answer": <div>
            <p>
                Unlike savings accounts who have predictable and consistent returns, returns from ETFs vary a lot. The annual volatility can be thought of as a way to measure the consistency of the returns. Therefore, the higher it is the riskier and more unpredictable the investment is. For reference, a savings account has a volatility of 0
            </p>
        </div>
    },
    {
        ...
        "answer": <div>
            <p>
                Can be thought of as a way to measure the quality of an investment’s return. It is the ratio of the average annual return to the annual volatility. Note: If the Sharpe is negative, it means that the average savings account performed better
            </p>
        </div>
    },
    {
        "question": "Analysis and Comparison: Positive Months Ratio",
        "description": "(Higher = better) Likelihood of an investment to have a positive month",
        "answer": <div>
            <p>
    ...
    },
    {
        ...
        "description": "(Lower = better) Worst return you can expect in month, with a 95% confidence",
        "answer": <div>
            <p>
    ...
    },
    {
        ...
        "description": "(Lower = better) Return per month in a very bad market",
        "answer": <div>
            <p>
